...
```text
Set up "empty" reducer and initial state **Check**👉 Set up store and Provider **Check** 👉
Connect components **Check** 👉 Add events and event handlers in UI 👉 Build action creators 👉
